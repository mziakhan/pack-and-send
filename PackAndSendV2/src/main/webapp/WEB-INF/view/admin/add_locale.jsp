...
<title>CIP | Localization Master</title>
<style>
.inline {
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<form class="form-horizontal"
					action="action?requestUrl=saveLocale" method="post">
					<div class="form-group">
						<label class="control-label col-md-6" for="email">Language:</label>
						<div class="col-md-10">
							<input type="text" class="form-control" name="locale" placeholder="Enter Spoken Language">
						</div>
					</div>
					<div class="form-group">
